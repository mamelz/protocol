...
_SCHEDULE_KEYWORDS_MANDATORY = FrozenDict(
    {
        "stages": list,
        "start_time": float
    }
...
_SCHEDULE_KEYWORDS_OPTIONAL = FrozenDict(
    {
        "global_options": dict,
        "label": str
    }
...
_STAGE_KEYWORDS_MANDATORY = FrozenDict(
    {
        "tasks": list
    }
)

_STAGE_KEYWORDS_OPTIONAL = FrozenDict(
    {
        "global_options": dict,
        "monitoring": list,
...
_TASK_KEYWORDS_MANDATORY = FrozenDict(
    {
        "routines": list
    }
)

_TASK_KEYWORDS_OPTIONAL = FrozenDict(
    {
        "global_options": dict
    }
)

_ROUTINE_KEYWORDS_MANDATORY = FrozenDict(
    {
        "kwargs": dict,
        "routine_name": str
    }
...
_ROUTINE_KEYWORDS_OPTIONAL = FrozenDict(
    {
        "description": "",
        "live_tracking": False,
        "output": True,
...
_EVO_ROUTINE_KEYWORDS_MANDATORY = FrozenDict(
    {
        "kwargs": dict,
        "routine_name": str,
        "time": float
